...
from dbmapcat import Restaurant, Base, MenuItem, User
...
restaurant1 = Restaurant(user_id=1, name="Urban Burger", address="1321 Commerce St, The Adolphus Hotel, Dallas, TX 75202", phone="989-234-6070", category="American", health_rating= "Poor(Sickness Likely)")
...
restaurant2 = Restaurant(user_id=1, name="Super Stir Fry", address="5500 Greenville Ave, Dallas, TX 75206", phone="989-245-6071", category="Asian", health_rating= "Failed(Cat Meat Found!)")
...
restaurant1 = Restaurant(user_id=1, name="Panda Garden",address="3511 Oak Lawn Ave, Dallas, TX 75219", phone="989-865-7530", category="Asian", health_rating= "Good")
...
restaurant1 = Restaurant(user_id=1, name="Thyme for That Vegetarian Cuisine", address="4901 Bryan St, Dallas, TX 75206-7613", phone="128-234-5550", category="Vegetarian", health_rating= "Excellent")
...
restaurant1 = Restaurant(user_id=1, name="Tony\'s Bistro", address="1322 Commerce St, The Adolphus Hotel, Dallas, TX 75202", phone="946-430-6070", category="Italian", health_rating= "Bravo")
...
# Menu for Andala's
restaurant1 = Restaurant(user_id=1, name="Andala's", address="10477 Lombardy Ln, Dallas, TX 75220-4349", phone="989-234-6070", category="Italian", health_rating= "Good(Capish?)")
...
restaurant1 = Restaurant(user_id=1, name="Auntie Ann\'s Diner' ", address="8300 Preston Road, Dallas, TX 75225", phone="989-504-6045", category="American", health_rating= "Fair(Flies in Gravy)")
...
restaurant1 = Restaurant(user_id=1, name="Cocina Y Amor ", address="2401 McKinney Ave, Dallas, TX 75201", phone="981-232-6570", category="Mexican", health_rating= "Poor(Sickness Likely)")
...
restaurant1 = Restaurant(user_id=1, name="Stratos", address="2907 W Northwest Hwy, Dallas, TX", phone="857-234-1270", category="Greek", health_rating= "Good")
session.add(restaurant1)
session.commit()
